...
import org.altbeacon.beaconreference.databinding.ActivityChatBinding;
...
public class ChatActivity extends AppCompatActivity {
    ...
    private void sendMessage(){
        ...
        if(conversionId!=null){
            updateConersation(binding.inputMessage.getText().toString());
        }else {
    ...
    private void updateConersation(String message){
    ...
    private void checkForConversationsRemotely(String senderId, String reciverId){
        database.collection(Constants.KEY_COLLECTION_CONVERSATIONS)
    ...
    private final OnCompleteListener<QuerySnapshot> conversionOnCompletionListener = task ->{
